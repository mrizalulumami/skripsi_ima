...
public class Pesanan_model {
	String totalstok,key, idpenyewa,idpenjual,namapenyewa,alamatpenyewa,namabarang,nohppenyewa,gambarbarang,totalharga,status,jenis,stok;
	int tgglsewa,rentgsewa;

	public Pesanan_model() {
	}

	public Pesanan_model(int tgglsewa,int rentgsewa,String totalstok,String idpenyewa, String idpenjual, String namapenyewa, String alamatpenyewa, String namabarang, String nohppenyewa, String gambarbarang, String totalharga, String status, String jenis,String stok) {
